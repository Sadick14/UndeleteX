...
disk_path = "/dev/sda2" #linux

# Open the disk image
img = pytsk3.Img_Info(disk_path)

output_dir="/home/agent47/Desktop/main/Python"
...
def list_files(fs, directory="/", output_dir="/home/agent47/Desktop/main/Python"):
    try:
...
list_files(fs, output_dir="/home/agent47/Desktop/main/Python")